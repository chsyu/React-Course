...
export function Basket({size}) {
   return (
      <svg 
         ...
         height={size}
      >
         <path fill="none" stroke="#ffffff" strokeLinecap="square" strokeWidth="1.5" strokeMiterlimit="10" d="M18.069 1.265l4 12M10.069 1.265l-4 12M1.069 9.265h26s-1 15-6 15h-14c-5 0-6-15-6-15z"></path>
      </svg>
   );
}
