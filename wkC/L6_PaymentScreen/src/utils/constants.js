...
export const RESET_ORDER_CREATE = 'RESET_ORDER_CREATE';
...
// GET ORDER DETAIL
export const BEGIN_ORDER_DETAILS = 'BEGIN_ORDER_DETAILS';
export const SUCCESS_ORDER_DETAILS = 'SUCCESS_ORDER_DETAILS';
