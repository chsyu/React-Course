          ...
          <div className="border border-secondary border-1 rounded overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-white opacity-3 mb-3">
                ...
                and has an appealing glaze in grey and blue that contributes to
                a rustic.
              </p>
              <div className="d-flex justify-content-between flex-wrap ">
                <a href="/" className="text-decoration-none text-color-1">
        ...
        <section className="col-md-6 col-lg-4 pt-4 p-md-3 p-lg-4">
          <div className="border border-secondary border-1 rounded overflow-hidden">
            ...
            <div className="p-4">
              ...
              <h5 className="text-white mb-3">Triplets easter rabbit 3-pack</h5>
              <p className="text-white opacity-3 mb-3">
        ...
        <section className="col-md-6 col-lg-4 pt-4 p-md-3 p-lg-4">
          <div className="border border-secondary border-1 rounded overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-white opacity-3 mb-3">
                Renew your home with the trendy Silvia lamp in white designed by
                the Danish brand Umage / Vita. Silvia is a lampshade made of
                polypropylene.
              </p>
              <div className="d-flex justify-content-between flex-wrap ">
                <a href="/" className="text-decoration-none text-color-1">
        ...
        <section className="col-md-6 col-lg-4 pt-4 p-md-3 p-lg-4">
          <div className="border border-secondary border-1 rounded overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-white opacity-3 mb-3">
                The High Dot stool leather from Fritz Hansen is a stable little
                seat made from premium leather and three legs of quality steel.
              </p>
              <div className="d-flex justify-content-between flex-wrap ">
                <a href="/" className="text-decoration-none text-color-1">
                  See More
        ...
        <section className="col-md-6 col-lg-4 pt-4 p-md-3 p-lg-4">
          <div className="border border-secondary border-1 rounded overflow-hidden">
            ...
            <div className="p-4">
              ...
              <p className="text-white opacity-3 mb-3">
                The Satake Kuro Chopper is a handmade and rough forged knife of
                exceptional quality. It has been developed with a focus on
                sharpness, precision .
              </p>
              <div className="d-flex justify-content-between flex-wrap ">
                <a href="/" className="text-decoration-none text-color-1">
